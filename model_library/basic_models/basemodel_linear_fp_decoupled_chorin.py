...
"""
from .basemodel_linear_decoupled_chorin import *
from fenics import *
import numpy as np
import warnings
import time

class basemodel_linear_fp_decoupled_chorin(basemodel_linear_decoupled_chorin):
    def __init__(self,  fp_tol = 1e-6, max_iter = 50, silent=True):
        super().__init__( silent)
        self.fp_tol = fp_tol
        self.max_iter = max_iter
        self.modelname = "basemodel_linear_fp_decoupled_chorin"
